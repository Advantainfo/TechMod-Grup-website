...
const labels = {
  ...
  bg: {
    ...
    story1: "Techmod Group е основана през 2014 г. с просто убеждение: разликата между архитектурното качество и практичността на строителството беше изкуствена. Най-добрите домове в света не трябваше да отнемат две години и трима изпълнители за изграждане.",
